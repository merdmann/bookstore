@include export-module('documenteditor-theme') {
  ...
  .e-de-toc-list-view.e-de-rtl {
    margin-left: 0;
    margin-right: $de-toc-list-view-margin-left;
  }
  ...
  .e-de-table-dialog-separator-line {
    ...
    margin-top: $de-table-dlg-seperator-line-top;
    position: absolute;
    ...
    .e-de-style-paragraph-indent-group-button {
      .e-btn {
        ...
        &:focus {
          ...
          border-color: $de-toggle-btn-border;
        }
  ...
  .e-bigger {
    .e-button-custom {
      ...
      width: $de-bigger-style-button-width;
    }
  }
  ...
  .e-de-table-border-fill.e-de-rtl {
    margin-left: $de-table-border-margin-right;
  }

  .e-de-table-border-fill:not(.e-de-rtl) {
    margin-right: $de-table-border-margin-right;
    margin-top: $de-table-border-margin-top;
  }
  ...
  .e-de-rp-btn-enforce {
    ...
    border-radius: 2px;
    box-shadow: 0 2px 2px 0 $de-rp-btn-nav-box-shadow, 0 2px 4px 0 $de-rp-btn-nav-box-shadow-next;
    font-size: 13px;
    height: 36px;
    opacity: .87;
  }
  ...
  .e-de-cmt-post-btn.e-btn.e-flat, .e-de-cmt-cancel-btn.e-btn.e-flat {
    ...
    margin-left : 8px;
    width: $de-cmt-post-btn-ht;
  }

  @if $skin-name == 'bootstrap4' {
    .e-de-cmt-cancel-btn.e-btn.e-flat, .e-de-cp-close.e-btn.e-flat {
      background-color: inherit;
      border: none;
    }
  ...
  .e-de-cmt-resolved {
    ...
    .e-de-cmt-author-name, .e-de-cmt-readonly, e-de-cmt-date {
      opacity: .67;
    }
